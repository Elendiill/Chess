...
public class ChessPlayer
{
    ...
    public Piece[] GetPiecesAttackingToType<T>() where T : Piece
    {
    ...
    public void RemoveMovesEnablingAttackOnPiece<T>(ChessPlayer opponet, Piece selectedPiece) where T : Piece
    {
        ...
        foreach (var coords in selectedPiece.avaliableMoves)
        {
            ...
            opponet.GenerateAllPossibleMoves();
            if (opponet.CheckIfIsAttackingPiece<T>())
